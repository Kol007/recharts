  ...
  _createClass(Tooltip, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          activePayload = _this$props.activePayload,
          isAnimationActive = _this$props.isAnimationActive,
          animationDuration = _this$props.animationDuration,
          animationEasing = _this$props.animationEasing,
          filterNull = _this$props.filterNull,
          paylodUniqBy = _this$props.paylodUniqBy;
      var tempPayload = activePayload ? activePayload : payload;
      var finalPayload = getUniqPaylod(paylodUniqBy, filterNull && tempPayload && tempPayload.length ? tempPayload.filter(function (entry) {
      ...
      var _this$props2 = this.props,
          ...
          activeActive = _this$props2.activeActive,
          offset = _this$props2.offset,
          wrapperStyle = _this$props2.wrapperStyle;
      var tempActive = activeActive ? activeActive : active;
